...
// SecretIterator abstracts the iterator for listing secrets
type SecretIterator interface {
	Next() (*secretmanagerpb.Secret, error)
}

// realSecretManagerClient wraps the actual GCP client
type realSecretManagerClient struct {
	client *secretmanager.Client
}

func (r *realSecretManagerClient) GetSecret(ctx context.Context, req *secretmanagerpb.GetSecretRequest) (*secretmanagerpb.Secret, error) {
	return r.client.GetSecret(ctx, req)
}

func (r *realSecretManagerClient) CreateSecret(ctx context.Context, req *secretmanagerpb.CreateSecretRequest) (*secretmanagerpb.Secret, error) {
	return r.client.CreateSecret(ctx, req)
}

func (r *realSecretManagerClient) DeleteSecret(ctx context.Context, req *secretmanagerpb.DeleteSecretRequest) error {
	return r.client.DeleteSecret(ctx, req)
}

func (r *realSecretManagerClient) AddSecretVersion(ctx context.Context, req *secretmanagerpb.AddSecretVersionRequest) (*secretmanagerpb.SecretVersion, error) {
	return r.client.AddSecretVersion(ctx, req)
}

func (r *realSecretManagerClient) AccessSecretVersion(ctx context.Context, req *secretmanagerpb.AccessSecretVersionRequest) (*secretmanagerpb.AccessSecretVersionResponse, error) {
	return r.client.AccessSecretVersion(ctx, req)
}

func (r *realSecretManagerClient) ListSecrets(ctx context.Context, req *secretmanagerpb.ListSecretsRequest) SecretIterator {
	return r.client.ListSecrets(ctx, req)
}

func (r *realSecretManagerClient) Close() error {
...
type GcpClient struct {
	...
	smClient  SecretManagerClient   `yaml:"-" json:"-"` // For testing
}

// SetSecretManagerClient allows injecting a mock client for testing
func (g *GcpClient) SetSecretManagerClient(client SecretManagerClient) {
	g.smClient = client
}

// getSecretManagerClient returns the configured client (mock or real)
func (g *GcpClient) getSecretManagerClient() SecretManagerClient {
	if g.smClient != nil {
		return g.smClient
	}
	if g.client != nil {
		return &realSecretManagerClient{client: g.client}
	}
	return nil
}
